...
opt.istest=0
print(ran[i])
print("AUC for criterion 1 (val): " + str(threewaytest.main(opt)[0]))
opt.istest=1
print("AUC for criterion 1 (test): " + str(threewaytest.main(opt)[0]))
...
opt.istest=0
print(ran[i])
print("AUC for criterion 2 (val): " + str(threewaytest.main(opt)[1]))
opt.istest=1
print("AUC for criterion 2 (test): " + str(threewaytest.main(opt)[1]))
...
opt.istest=0
print(ran[i])
print("AUC for criterion 3 (val): " + str(threewaytest.main(opt)[2]))
opt.istest=1
print("AUC for criterion 3 (test): " + str(threewaytest.main(opt)[2]))
...
opt.istest=0
print(ran[i])
print("AUC for criterion 4 (val): " + str(threewaytest.main(opt)[3]))
opt.istest=1
print("AUC for criterion 4 (test): " + str(threewaytest.main(opt)[3]))
