...
for classname in folders:   #[8,2,3,0,1,4,5,6,7,9]:#folders:
	...
	novellist = list(set(folders)-set([classname]))
 	print(novellist)
        ...
        trainerr = []
        valerr =[]
        os.system('python2 cvpriterAAC.py --epochs 201 --batch_size 512  --ndf 12  --ngf 64 --istest 0 --expname cifarnorm  --img_wd 61 --img_ht 61 --depth 3 --datapath ../  --noisevar 0.2  --lambda1 10 --seed 1000 --append 0 --dataset cifarnorm  --latent '+str(opt.latent))
